...
function halfDayButtonClick() {
    ...
    halfDayButtonElement.classList.add('clicked');
    fullDayButtonElement.classList.remove('clicked');
    // I dont know why this isnt working. Could you please explain it to me when youre done marking ... thank you.
}
...
function fullDayButtonClick() {
    ...
    fullDayButtonElement.classList.add('clicked');
    halfDayButtonElement.classList.remove('clicked');
    // I dont know why this isnt working. Could you please explain it to me when youre done marking ... thank you. 
}
